  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hintText,
        labelText: labelText,
        border: isBorder ?? false ? OutlineInputBorder() : null,
        enabledBorder: isUnderline ?? false ? UnderlineInputBorder() : null,
