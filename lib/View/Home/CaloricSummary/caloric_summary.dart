            ...
            child: RefreshIndicator.adaptive(
              ...
              child: ListView(
                children: [
                  ...
                  Card(
                    ...
                    child: SizedBox(
                      ...
                      child: SfCircularChart(
                        ...
                        title: const ChartTitle(text: 'Caloric Intake Report for Today', textStyle: TextStyle(fontSize: 18)),
                  ...
                  Consumer<CaloriesProvider>(builder: (context, value, child) {
...
Widget returnMealsBasedonSelectedIndex(CaloriesProvider caloriesProvider) {
  return ValueListenableBuilder<int>(
    ...
    builder: (context, selectedMealIdValue, child) {
      var filteredMeals = caloriesProvider.caloricIntakeData?.details?.where((element) => element.mealTimeId == selectedMealIdValue).toList() ?? [];
